...
function Portfolios({text},ref) {
    let portfolio1 = "https://wpriverthemes.com/HTML/drake/assets/images/portfolio1.jpg";
    return ( 
                            ...
                            <div className="row portfolio-items">
                                    ...
                                    <div className="portfolio-item portfolio-full">
                                        <div className="portfolio-item-inner">
                                            <a href={portfolio1} data-lightbox="example-1">
                                                <img src="/portfolio1.jpg" alt="Portfolio"/>
                                            </a>
                                ...
                                <div className="col-md-6 scroll-animation" data-animation="fade_from_left">
                                    <div className="portfolio-item portfolio-half">
                                        <div className="portfolio-item-inner">
                                            <a href="https://wpriverthemes.com/HTML/drake/assets/images/portfolio2.jpg" data-lightbox="example-1">
                                ...
                                <div className="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div className="portfolio-item portfolio-half">
                                        <div className="portfolio-item-inner">
                                            <a href="https://wpriverthemes.com/HTML/drake/assets/images/portfolio3.jpg" data-lightbox="example-1">
                                ...
                                <div className="col-md-12 scroll-animation" data-animation="fade_from_bottom">
                                    <div className="portfolio-item portfolio-half">
                                        <div className="portfolio-item-inner">
                                            <a href="https://wpriverthemes.com/HTML/drake/assets/images/portfolio4.jpg" data-lightbox="example-1">
                                                <img src="/portfolio4.jpg" alt="Portfolio"/>
                                            </a>
                                ...
                                <div className="col-md-12 scroll-animation" data-animation="fade_from_bottom">
                                    <div className="portfolio-item portfolio-half">
                                        <div className="portfolio-item-inner">
                                            <a href="https://wpriverthemes.com/HTML/drake/assets/images/portfolio5.jpg" data-lightbox="example-1">
                                                <img src="/portfolio5.jpg" alt="Portfolio"/>
                                            </a>
